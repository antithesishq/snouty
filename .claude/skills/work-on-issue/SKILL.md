...
was already green gets its "all checks passed" line on the second poll:
check which commit it names before you act on it. The watcher also emits a
line when the PR's base branch changes.
